...
export const julesGoogleComZhCn = {
  ...
  regexRules: [
    ...
    [/^Jan\s+(\d{1,2}),\s+(\d{4})$/i, "$2 年 1 月 $1 日"],
    [/^Feb\s+(\d{1,2}),\s+(\d{4})$/i, "$2 年 2 月 $1 日"],
    [/^Mar\s+(\d{1,2}),\s+(\d{4})$/i, "$2 年 3 月 $1 日"],
    [/^Apr\s+(\d{1,2}),\s+(\d{4})$/i, "$2 年 4 月 $1 日"],
    [/^May\s+(\d{1,2}),\s+(\d{4})$/i, "$2 年 5 月 $1 日"],
    [/^Jun\s+(\d{1,2}),\s+(\d{4})$/i, "$2 年 6 月 $1 日"],
    [/^Jul\s+(\d{1,2}),\s+(\d{4})$/i, "$2 年 7 月 $1 日"],
    [/^Aug\s+(\d{1,2}),\s+(\d{4})$/i, "$2 年 8 月 $1 日"],
    [/^Sep\s+(\d{1,2}),\s+(\d{4})$/i, "$2 年 9 月 $1 日"],
    [/^Oct\s+(\d{1,2}),\s+(\d{4})$/i, "$2 年 10 月 $1 日"],
    [/^Nov\s+(\d{1,2}),\s+(\d{4})$/i, "$2 年 11 月 $1 日"],
    [/^Dec\s+(\d{1,2}),\s+(\d{4})$/i, "$2 年 12 月 $1 日"],
