...
(() => {
  ...
  var aistudioGoogleCom = [
    ...
    ["Creativity allowed in the responses", "调整回复的创造力"],
  ...
  var consoleAnthropicCom = [
    ...
    ["Set a monthly spend limit for organization.", "为组织设定每月支出限额。"]["Set Limit", "设置限额"],
    ["Create workspace", "创建工作空间"],
    ["Workspaces allow you to separate API Keys and configurations by use case.", "工作区允许您根据使用案例分离 API 密钥和配置。"]["Enter a name for your workspace", "输入您的工作空间名"],
    ["Color", "颜色"],
