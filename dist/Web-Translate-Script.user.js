...
// @version      1.0.46-2025-10-7-offline
...
(() => {
  ...
  var wplaceLiveZhCn = {
    ...
    textRules: [
      ["In these cases, the cardholder must contact the financial institution directly to take appropriate actions, such as blocking the card, disputing charges, and requesting a reversal, according to the bank or card operator's rules.", '在这些情况下，持卡人必须直接联系金融机构采取适当措施，例如根据银行或发卡机构的规定挂失卡片、对收费提出异议以及申请退单。'],
      ...
      ['Disputes over purchases made by unauthorized users, when it is not possible to prove a system failure.', '未经授权的用户进行的购买产生争议，且无法证明是系统故障所致。'],
      ["Refunds will only be considered in situations where a technical failure of the platform's system is proven.", '只有在证明平台系统存在技术故障的情况下，才会考虑退款。'],
      ['🚫 No inappropriate content (+18, hate speech, inappropriate links, highly suggestive material, ...)', '🚫 禁止不当内容（+18、仇恨言论、不当链接、强暗示性内容等）'],
      ['You are unable to use the service due to technical issues with Wplace lasting more than 24 hours.', '由于 Wplace 的技术问题导致您超过24小时无法使用服务。'],
      ...
      ['The refund will be processed using the same payment method and will occur within 7 to 30 days.', '退款将通过原支付方式处理，并将在7到30天内完成。'],
      ...
      ['Provide your user ID, registered email, proof of payment, and reason for the request.', '提供您的用户ID、注册邮箱、付款证明以及申请原因。'],
      ['There is a violation of the terms of use, especially in cases of account ban.', '存在违反使用条款的行为，特别是在账户被封禁的情况下。'],
      ['You have not used the services within 7 calendar days after purchase.', '您在购买后的7个日历日内未使用过该服务。'],
      ...
      ['Wplace will respond within 10 business days.', 'Wplace 将在10个工作日内作出回应。'],
      ['Cancellation occurs after the services have been used.', '在使用服务后取消。'],
      ['More than 7 days have passed since the purchase.', '自购买之日起已超过7天。'],
